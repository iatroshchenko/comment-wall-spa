...
deploy:
	...
	sleep 10
	ssh ${USER}@${HOST} -p ${PORT} 'cd ${COMPOSE_PROJECT_NAME}_${BUILD_NUMBER} && echo "php artisan migrate --force" | docker-compose --env-file ./env/.env.production -f docker-compose.prod.yml exec -T app-php-fpm bash'
